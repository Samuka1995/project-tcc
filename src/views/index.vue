    ...
    <div>
        ...
        <div v-if="solicitarReserva" class="container-request-reservation">
            <div v-if="solicitacaoReserva" class="container-header-reserve" >
                ...
                <div class="header-logo">{{ solicitacaoOuReserva }}</div>
        ...
        <div v-if="historicoReservas" class="container-histoc-reservations">
            <router-link to="/minha-reserva" class="arrow-left">
                <em class="arrow-left">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="35"
            ...
            <div class="container-header-historic-reservations">Histórico Reservas</div>
...
export default {
    ...
    computed: {
        ...
        solicitarReserva(){
            return ['login.solicitacaoreserva', "login.minhareserva"].includes(this.$route.name)
        },
        termoUso() {
        ...
        historicoReservas() {
            return['login.historicoreservas'].includes(this.$route.name)
        },
    },
    ...
    methods: {
        ...
        textoSolicitacaoReserva() {
            this.solicitacao = ['login.solicitacaoreserva'].includes(this.$route.name)
            this.reserva = ['login.minhareserva'].includes(this.$route.name)
            if(this.solicitacao) return this.solicitacaoOuReserva = 'Solicitação de Reserva'
            if(this.reserva) return this.solicitacaoOuReserva = 'Reserva'
        },
...
<style >
    * {
    ...
    .container-header-historic-reservations {
        background: #9146ff;
        color: #fff;
        width: 80%;
        display: flex;
